    ...
    <div>
      ...
      <section className="text-white body-font">
        <div className="container mx-auto flex px-5 py-24">
          <div className="flex flex-col md:flex-row items-center md:space-x-4  ">
            <Image
              className="object-cover object-center w-full h-[150px] mt-530px ml-300px radius-6px"
              alt="hero"
              src= "/Shoplist.png" width={309} height={536} 
            />
          </div>
          {/* Right Images */}
      ...
      <section className="text-white body-font">
        <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col w-[579px]">
          ...
          <Image
            className="mb-10 object-cover object-center w-[1320px] h-[386px]  ml-[300px]"
            alt="hero"
            src = "/whychooseus.png"
